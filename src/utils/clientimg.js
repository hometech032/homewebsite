...
export const background=()=>[
    ...
    `${require('../assets/background/1.jpeg')}`,
    `${require('../assets/background/2.jpeg')}`,
    `${require('../assets/background/3.jpeg')}`,
    `${require('../assets/background/4.jpeg')}`,
    ...
    `${require('../assets/background/10.png')}`,
    `${require('../assets/background/11.png')}`,
    `${require('../assets/background/12.png')}`,
   //security 14- 16
   `${require('../assets/background/security1.png')}`,
   `${require('../assets/background/security2.png')}`,
   `${require('../assets/background/security3.png')}`,
  //cleaning 17-18
...
export const food=()=>[
    ...
    `${require('../assets/food/about-background-image.png')}`,
    `${require('../assets/food/about-background.png')}`,
    `${require('../assets/food/home-banner-background.png')}`,
    `${require('../assets/food/home-banner-image.png')}`,


    `${require('../assets/food/1.png')}`,
    `${require('../assets/food/2.png')}`,
